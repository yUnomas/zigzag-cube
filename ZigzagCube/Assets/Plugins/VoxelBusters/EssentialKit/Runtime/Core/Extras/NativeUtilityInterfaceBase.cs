...
namespace VoxelBusters.EssentialKit.ExtrasCore
{
    public abstract class NativeUtilityInterfaceBase : NativeFeatureInterfaceBase, INativeUtilityInterface
    {
        ...
        public abstract void RequestInfoForAgeCompliance(RequestInfoForAgeComplianceOptions options, EventCallback<InfoForAgeCompliance> onComplete, AgeComplianceMockData mockData = null);
