...
namespace VoxelBusters.EssentialKit.Editor
{
    public static class EssentialKitMenuManager
    {
        ...
        private const string kMenuItemPath = "Window/Voxel Busters/Essential Kit Lite";
        ...
        [MenuItem(kMenuItemPath + "/Uninstall/Uninstall for Upgrading")]
        public static void UninstallForUpgrading()
        {
            UninstallPlugin.Uninstall(completely: true);
        }

        [MenuItem(kMenuItemPath + "/Uninstall/Uninstall but retain EDMU plugin")]
        public static void UninstallCompletely()
        {
            UninstallPlugin.Uninstall(completely: false);
        }
        
        [MenuItem(kMenuItemPath + "/Upgrade to Full Version", isValidateFunction: true)]
        private static void UpgradeToFullVersion()
        {
            EssentialKitEditorUtility.OpenAssetStorePage(fullVersion: true);
        }
