...
namespace VoxelBusters.EssentialKit.ExtrasCore.Android
{
    public class NativeApplicationUtility : NativeAndroidJavaObjectWrapper
    {
        ...
        public void RequestInfoForAgeCompliance(NativeRequestInfoForAgeComplianceOptions options, NativeRequestInfoForAgeComplianceListener listener, NativeAgeComplianceMockData mockData)
        {
#if NATIVE_PLUGINS_DEBUG_ENABLED
            DebugLogger.Log("[Class : NativeApplicationUtility][Method : RequestInfoForAgeCompliance]");
#endif
            Call(Native.Method.kRequestInfoForAgeCompliance, new object[] { options?.NativeObject, listener, mockData?.NativeObject } );
        }
        ...
        internal class Native
        {
            ...
            internal class Method
            {
                ...
                internal const string kRequestInfoForAgeCompliance = "requestInfoForAgeCompliance";
            }
