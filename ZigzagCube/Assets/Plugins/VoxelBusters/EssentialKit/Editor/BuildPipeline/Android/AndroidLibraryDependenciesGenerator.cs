				...
				xmlWriter.WriteStartDocument();
				{
					...
					xmlWriter.WriteStartElement("dependencies");
					{
						xmlWriter.WriteStartElement ("androidPackages");
						{
							...
							{
								xmlWriter.WriteComment("Dependency added for using Age Compliance api. For ex: Play Age Signals Api");
								AndroidDependency playCoreAgeComplianceDependency = new AndroidDependency("com.google.android.play", "age-signals", PlayAgeSignalsVersionString);
								WritePackageDependency(xmlWriter, playCoreAgeComplianceDependency);
							}
